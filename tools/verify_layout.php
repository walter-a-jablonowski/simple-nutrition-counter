...
$foods  = array_keys( Yaml::parse( file_get_contents('data/bundles/Default_JaneDoe@example.com_24080101000000/foods.yml')));
$layout = Yaml::parse( file_get_contents('data/bundles/Default_JaneDoe@example.com_24080101000000/layouts/food.yml'));
