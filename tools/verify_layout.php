...
$foods  = array_keys( Yaml::parse( file_get_contents('data/bundles/Default_1/foods.yml')));
$layout = Yaml::parse( file_get_contents('data/bundles/Default_1/layouts/food.yml'));
