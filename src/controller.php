...
class FoodsController extends ControllerBase
{
  ...
  public function render(/*$request*/)
  {
    ...
    $this->layout = parse_attribs('@attribs', ['short', '(i)'], Yaml::parse( file_get_contents('data/bundles/Default_1/layouts/food.yml')));
    $this->goals  = Yaml::parse( file_get_contents('data/bundles/Default_1/layouts/goals.yml'));
    ...
    // $this->foodsTxt = file_get_contents('data/bundles/Default_1/foods.yml');  // old
  ...
  private function makeFoodsView()
  {
    ...
    $this->model->set('foods', Yaml::parse( file_get_contents('data/bundles/Default_1/foods.yml')));
